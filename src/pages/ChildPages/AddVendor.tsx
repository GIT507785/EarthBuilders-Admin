    ...
    <div className="mt-5">
        <form onSubmit={submitHandler} className="h-screen px-10 py-5 overflow-y-auto no-scrollbar border border-gray-300 rounded w-fulll">
          ...
          <div className="flex gap-5">
           ...
           <div>
                <h1 className="mt-5 text-gray-600 font-medium">Company Name</h1>
                <input type="text" value={input?.compnayName || ''}  placeholder="Enter Company Name"
                 className="border mt-2 border-gray-300 outline-none px-4 py-2 rounded-md w-80"
                onChange={(e)=>setInput({...input , compnayName:e.target.value })}  />
              </div>

              <div>
                <h1 className="mt-5 text-gray-600 font-medium">Vendor Description</h1>
                <textarea value={input?.vendorDescription || ''}  placeholder="Enter Vendor Description"
                 className="border mt-2 border-gray-300 outline-none px-4 py-2 rounded-md w-80"
                onChange={(e)=>setInput({...input , vendorDescription:e.target.value })}  />
              </div>
         ...
         <div>
          ...
          justify-center rounded-full"> <HandshakeIcon className="size-5"/> Add Vendor</button>
