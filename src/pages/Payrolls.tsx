    ...
    >
      ...
      <div className="lg:hidden space-y-3">
        ...
        <div className="flex justify-between">
          ...
          <span className="ml-6">0{item.serial}.</span>
        </div>

        <div className="flex justify-between">
          <span className="font-semibold">Employee Name</span>
          <span className="ml-6">{item.employeName}</span>
        </div>

        <div className="flex justify-between">
          <span className="font-semibold">Pay Period</span>
          <span className="ml-6">{item.PayPeriod}</span>
        </div>

        <div className="flex justify-between">
          <span className="font-semibold">Expenses</span>
          <span className="text-right ml-6">${item.Epenses.toFixed(2)}</span>
        </div>

        <div className="flex justify-between">
          <span className="font-semibold">Hours Worked</span>
          <span className="ml-6">{item.huorsWorked}</span>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <span
            className={`px-4 py-1 rounded-full ml-6 text-sm text-white ${
              item.status === "paid"
                ? "bg-emerald-600"
                : item.status === "pending"
                ? "bg-orange-400"
        ...
        <div className="flex justify-between">
          ...
          <LiaEllipsisVSolid className="text-xl ml-6 cursor-pointer" />
        </div>
      </div>
